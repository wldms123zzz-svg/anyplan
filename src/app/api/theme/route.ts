...
4. ⚠️ 극강의 랜덤성 (제일 중요): 내가 방금 말한 예시들은 절대 똑같이 반복 출력하지 마! 이 세상에는 수만 가지의 놀거리가 있어. 매번 완전히 다른 카테고리(스포츠, 힐링, 이색 체험, 병맛 대결, 감성 투어 등)에서 상상력을 발휘해서 미치도록 새롭고 다양한 코스를 무한정 창작해서 내놓아야 해.
